 ...
 * @param res
 */
export const createBillService = async function (
  req: BillRequest,
  ...
  try {
    ...
    validateRequiredFields(
      req.body,
      ["user_id", "book_id", "amount", "category_id"],
      {
        user_id: "用户ID",
        book_id: "账本ID",
        amount: "金额",
...
export const billListService = async function (
  req: Request,
  res: Response<ApiResponse>
) {
  try {
    ...
    return await billModule.billList(
      userId,
      page,
      pageSize,
      start_time,
...
export const billRemoveService = async function (
  req: Request,
  res: Response<ApiResponse>
) {
  try {
 ...
 * @param res
 */
export const billInfoService = async function (
  req: Request,
  res: Response<ApiResponse>
) {
  try {
