...
import {userInfo} from "../../controllers/miniProgram/authController.ts";
=======
...
export const createBudgetService = async (req: BudgetRequest, res: Response<ApiResponse>) => {
...
export const budgetInfoService = async (req: Request, res: Response<BudgetDbSchema>) => {
    try {
        // @ts-ignore
