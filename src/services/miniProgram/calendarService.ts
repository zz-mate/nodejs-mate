...
export const calendarDateService = (req: Request, res: Response) => {
  const { userId, bookId, start_time, page, pageSize, categoryId, type } =
    req.body;
  return calendarModule.calendarDate(
    userId,
    bookId,
    start_time,
    page,
...
export const calendarMonthChartService = (req: Request, res: Response) => {
  const { userId, bookId, start_time,end_time, type } = req.body;
  return calendarModule.calendarMonthChart(userId, bookId, start_time,end_time, type);
};
